...
ini_set('display_errors','on'); error_reporting(E_ALL & ~E_STRICT & ~E_NOTICE & ~E_DEPRECATED & ~E_WARNING);   // DEBUGGING
...
$HELPDESK_SUPPORT_EMAIL_ID = 'emmanuel.durand@sortirdunucleaire.fr';
$HELPDESK_SUPPORT_NAME = 'Emmanuel';
...
$dbconfig['db_port'] = '';
$dbconfig['db_username'] = 'lamatrice';
$dbconfig['db_password'] = 'GhqQKnjxxhrhfvZC';
$dbconfig['db_name'] = 'lamatrice';
...
$site_URL = 'http://10.0.0.180/lamatrice/';

// root directory path
$root_directory = '/var/www/lamatrice/';
...
$application_unique_key = 'ed5ac26b7725519d681cdea05d260a8f';
