<?php /* Smarty version Smarty-3.1.7, created on 2014-12-01 11:57:06
         compiled from "/Users/cogi4d/Sites/lamatrice/includes/runtime/../../layouts/vlayout/modules/Documents/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1279683589545cd9a996ba20-43020613%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cee5cc9fd4013b79d793192451d063984f4730d0' => 
    array (
      0 => '/Users/cogi4d/Sites/lamatrice/includes/runtime/../../layouts/vlayout/modules/Documents/ListViewContents.tpl',
      1 => 1413619434,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1279683589545cd9a996ba20-43020613',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_545cd9a9cb342',
  'variables' => 
  array (
    'VIEW' => 0,
    'PAGING_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_545cd9a9cb342')) {function content_545cd9a9cb342($_smarty_tpl) {?>
...
?><?php $_smarty_tpl->tpl_vars['UICOLOR'] = new Smarty_variable($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get('uicolor'), null, 0);?><tr class="listViewEntries" data-id='<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getId();?>
...
" nowrap="nowrap"<?php if (($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value=='folderid')&&($_smarty_tpl->tpl_vars['UICOLOR']->value!=null)&&($_smarty_tpl->tpl_vars['UICOLOR']->value!='')){?>style="background-color: <?php echo $_smarty_tpl->tpl_vars['UICOLOR']->value;?>
;"<?php }?>><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->isNameField()==true||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('uitype')=='4'){?><a href="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getDetailViewUrl();?>
...
<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value);?>
<?php }?><?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('uitype')=='402'){?><?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value);?>
