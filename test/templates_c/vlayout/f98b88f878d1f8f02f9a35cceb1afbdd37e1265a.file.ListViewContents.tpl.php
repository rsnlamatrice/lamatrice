<?php /* Smarty version Smarty-3.1.7, created on 2015-01-09 17:01:55
         compiled from "/var/www/lamatrice/includes/runtime/../../layouts/vlayout/modules/Documents/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:174564640854affb735559c8-70698703%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f98b88f878d1f8f02f9a35cceb1afbdd37e1265a' => 
    array (
      0 => '/var/www/lamatrice/includes/runtime/../../layouts/vlayout/modules/Documents/ListViewContents.tpl',
      1 => 1420811145,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '174564640854affb735559c8-70698703',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54affb736aba0',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54affb736aba0')) {function content_54affb736aba0($_smarty_tpl) {?>
...
" nowrap="nowrap"><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->isNameField()==true||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('uitype')=='4'){?><a href="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getDetailViewUrl();?>
...
<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value);?>
<?php }?><?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('uitype')=='402'){?><?php }else{ ?><?php if (($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value=='folderid')){?><div style="background-color:<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get('uicolor');?>
; margin-left:0;" class="picklistvalue-uicolor">&nbsp;</div><?php }?><?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value);?>
