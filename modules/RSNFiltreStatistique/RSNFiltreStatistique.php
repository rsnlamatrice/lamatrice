...
class RSNFiltreStatistique extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_rsnfiltrestatistique';
	var $table_index= 'rsnfiltrestatistiqueid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_rsnfiltrestatistiquecf', 'rsnfiltrestatistiqueid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_rsnfiltrestatistique', 'vtiger_rsnfiltrestatistiquecf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_rsnfiltrestatistique' => 'rsnfiltrestatistiqueid',
		'vtiger_rsnfiltrestatistiquecf'=>'rsnfiltrestatistiqueid');

	/**
	 * Mandatory for Listing (Related listview)
	 */
	var $list_fields = Array (
		'LBL_NAME' => array('rsnfiltrestatistique', 'name'),
	...
	var $search_fields = Array(
		'LBL_FILTERNAMEFIELDNAME' => array('rsnfiltrestatistique', 'filternamefieldname'),
		'LBL_FILTERVALUEQUERY' => array('rsnfiltrestatistique', 'filtervaluequery'),
		'LBL_NAME' => array('rsnfiltrestatistique', 'name'),

	);
	var $search_fields_name = Array (
		'LBL_FILTERNAMEFIELDNAME' => 'filternamefieldname',
		'LBL_FILTERVALUEQUERY' => 'filtervaluequery',
		'LBL_NAME' => 'name',
