...
class Invoice_Record_Model extends Inventory_Record_Model {
	...
	public function getPicklistValuesDetails($fieldname){
		switch($fieldname){
			...
			case 'invoicestatus':
				return array(
					'Created' => array( 'label' => 'CrÈÈ', 'icon' => 'ui-icon ui-icon-check orange' ),
					'Validated' => array( 'label' => 'ValidÈ', 'icon' => 'ui-icon ui-icon-check darkgreen' ),
					'Compta' => array( 'label' => 'ArchivÈ', 'icon' => 'ui-icon ui-icon-close blue' ),
					'Cancelled' => array( 'label' => 'AnnulÈ', 'icon' => 'ui-icon ui-icon-close darkred' ),
