    ...
    */
    public function handleAfterSaveInvoiceAbonnementsEvent($invoice, $categoryItems, $account)
    {
        ...
        foreach ($categoryItems as $nLine => $lineItem) {
            ...
            if ($productCode === 'RSGR' || $productCode === 'RSGR2') { //Abonnements groupés (supplémentaires)
        ...
        foreach ($categoryItems as $nLine => $lineItem) { //tmp mettre fin aux numero découverte / offert en cas d'abo payant !!!
            ...
            $aboType = $productCode;
            $nbExemplaires = 1;
            // Prise en compte des nouveaux type d'abonnement. Les noms des services ont changé, mais le comportement pour les dates reste le même
            ...
            if ($productCode === 'RABOPB') {
                $productCode = 'RABOG';
            } elseif ($productCode === 'RABOGROU2' || $productCode === 'RPARR2' || $productCode === 'RABOS2' || $productCode === 'RSGR2' || $productCode === 'RABO2') {
