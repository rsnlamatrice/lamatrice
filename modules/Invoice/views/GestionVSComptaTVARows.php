...
class Invoice_GestionVSComptaTVARows_View extends Invoice_GestionVSComptaTVA_View {
	...
	public function initFormData(Vtiger_Request $request) {
		...
		$viewer->assign('FORM_VIEW', 'GestionVSComptaTVARows');
	}
	...
	public function getLaMatriceRowsEntries($dateDebut, $dateFin, $compte){
		...
		foreach($allTaxes as $tax){
			...
			";
			if($compte)
				$query .= " AND `vtiger_inventorytaxinfo`.`account` IN ( ".$compte." )
				";
			$query .= "
