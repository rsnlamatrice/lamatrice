...
class RSNPreconfiguredExport extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_rsnpreconfiguredexport';
	var $table_index= 'rsnpreconfiguredexportid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_rsnpreconfiguredexportcf', 'rsnpreconfiguredexportid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_rsnpreconfiguredexport', 'vtiger_rsnpreconfiguredexportcf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_rsnpreconfiguredexport' => 'rsnpreconfiguredexportid',
		'vtiger_rsnpreconfiguredexportcf'=>'rsnpreconfiguredexportid');

	/**
	 * Mandatory for Listing (Related listview)
	 */
	var $list_fields = Array (
		'LBL_RELATEDMODULE' => array('rsnpreconfiguredexport', 'relatedmodule'),
		'LBL_CLASSNAME' => array('rsnpreconfiguredexport', 'classname'),
		'LBL_DESCRIPTION' => array('rsnpreconfiguredexport', 'description'),
		'LBL_EXPORTTYPE' => array('rsnpreconfiguredexport', 'exporttype'),
		'LBL_EXPORTNAME' => array('rsnpreconfiguredexport', 'exportname'),
	...
	var $list_fields_name = Array (
		...
		'LBL_EXPORTTYPE' => 'exporttype',
		'LBL_EXPORTNAME' => 'exportname',
