...
class Critere4D_RelatedList_View extends Vtiger_RelatedList_View {
	function process(Vtiger_Request $request) {
		...
		if (array_key_exists($relatedModuleName, $relationModel->getModulesInfoForDetailView())) {
			$user_model = Users_Record_Model::getCurrentUserModel();
			//var_dump(count(CustomView_Record_Model::getAllByGroup($relatedModuleName)));
