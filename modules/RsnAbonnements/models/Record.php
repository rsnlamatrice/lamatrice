 ...
 */
class RsnAbonnements_Record_Model extends Vtiger_Record_Model {
...
/**
	...
	public function getFullDetailViewUrl() {
		...
		return 'index.php?module=Invoice&view='.$module->getDetailViewName().'&record='.$this->getId().'&mode=showDetailViewByMode&requestMode=full';
	}
	...
	public function getEditViewUrl() {
		$module = $this->getModule();
		return 'index.php?module=Invoice&view='.$module->getEditViewName().'&record='.$this->getId();
	}
	...
	public function getDeleteUrl() {
		$module = $this->getModule();
		return 'index.php?module=Invoice&action='.$module->getDeleteActionName().'&record='.$this->getId();
	}
