...
class Vtiger_RelationListView_Model extends Vtiger_Base_Model {
	...
	public function getEntries($pagingModel) {
		...
		case "RSNStatistics"://TODO supprimer
			if($parentModule->getName() == "RSNStatistics"//TODO supprimer
			|| $parentModule->getName() == "RSNStatisticsResults"){
	 ...
	 *
	 * Je crois qu'ˆ cette heure, le filtrage des en-ttes de liste liŽe n'est pas vraiment opŽrationnelle
	 */
