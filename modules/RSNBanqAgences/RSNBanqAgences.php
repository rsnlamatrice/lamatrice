...
class RSNBanqAgences extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_rsnbanqagences';
	var $table_index= 'rsnbanqagencesid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_rsnbanqagencescf', 'rsnbanqagencesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_rsnbanqagences', 'vtiger_rsnbanqagencescf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_rsnbanqagences' => 'rsnbanqagencesid',
		'vtiger_rsnbanqagencescf'=>'rsnbanqagencesid');

	/**
	 * Mandatory for Listing (Related listview)
	 */
	var $list_fields = Array (
		'LBL_CODEAGENCE' => array('rsnbanqagences', 'codeagence'),
		'LBL_RSNBANQUESID' => array('rsnbanqagences', 'rsnbanquesid'),
		'LBL_BIC' => array('rsnbanqagences', 'bic'),

	);
	var $list_fields_name = Array (
		'LBL_CODEAGENCE' => 'codeagence',
		'LBL_RSNBANQUESID' => 'rsnbanquesid',
		'LBL_BIC' => 'bic',
	...
	function RSNBanqAgences() {
		$this->log =LoggerManager::getLogger('RSNBanqAgences');
		$this->db = PearDatabase::getInstance();
		$this->column_fields = getColumnFields('RSNBanqAgences');
	}
