...
class RSNContactsPanels extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_rsncontactspanels';
	var $table_index= 'rsncontactspanelsid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_rsncontactspanelscf', 'rsncontactspanelsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_rsncontactspanels', 'vtiger_rsncontactspanelscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_rsncontactspanels' => 'rsncontactspanelsid',
		'vtiger_rsncontactspanelscf'=>'rsncontactspanelsid');

	/**
	 * Mandatory for Listing (Related listview)
	 */
	var $list_fields = array (
		'LBL_RSNCONTACTSPANELSDOMAINS' => array('rsncontactspanels', 'rsncontactspanelsdomains'),
		'LBL_QUERY' => array('rsncontactspanels', 'query'),
		'LBL_PRE_SCRIPT' => array('rsncontactspanels', 'pre_script'),
		'LBL_NAME' => array('rsncontactspanels', 'name'),
		'LBL_DESCRIPTION' => array('rsncontactspanels', 'description'),
		'LBL_RSNCONTACTSPANELSSTATUS' => array('rsncontactspanels', 'rsncontactspanelsstatus'),
		'LBL_POST_SCRIPT' => array('rsncontactspanels', 'post_script'),

);
	var $list_fields_name = array (
		'LBL_RSNCONTACTSPANELSDOMAINS' => 'rsncontactspanelsdomains',
		'LBL_QUERY' => 'query',
		'LBL_PRE_SCRIPT' => 'pre_script',
		'LBL_NAME' => 'name',
		'LBL_DESCRIPTION' => 'description',
		'LBL_RSNCONTACTSPANELSSTATUS' => 'rsncontactspanelsstatus',
		'LBL_POST_SCRIPT' => 'post_script',
	...
	var $search_fields = array (
		'LBL_POST_SCRIPT' => array('rsncontactspanels', 'post_script'),
		'LBL_DURATION' => array('rsncontactspanels', 'duration'),
		'LBL_DESCRIPTION' => array('rsncontactspanels', 'description'),
		'LBL_LOCKED' => array('rsncontactspanels', 'locked'),
		'LBL_RSNCONTACTSPANELSSTATUS' => array('rsncontactspanels', 'rsncontactspanelsstatus'),
		'LBL_RSNCONTACTSPANELSDOMAINS' => array('rsncontactspanels', 'rsncontactspanelsdomains'),
		'LBL_QUERY' => array('rsncontactspanels', 'query'),
		'LBL_PRE_SCRIPT' => array('rsncontactspanels', 'pre_script'),
