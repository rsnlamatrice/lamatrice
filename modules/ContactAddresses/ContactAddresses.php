...
class ContactAddresses extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_contactaddresses';
	var $table_index= 'contactaddressesid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_contactaddressescf', 'contactaddressesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_contactaddresses', 'vtiger_contactaddressescf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_contactaddressescf'=>'contactaddressesid');

	/**
	 * Mandatory for Listing (Related listview)
	 */
	var $list_fields = Array (
		'LBL_ADDRESSTYPE' => array('contactaddresses', 'addresstype'),
		'LBL_COMMENTS' => array('contactaddresses', 'comments'),

	);
	var $list_fields_name = Array (
		'LBL_ADDRESSTYPE' => 'addresstype',
