...
class RSNImportSources_ImportBRFournFromCogilog_View extends RSNImportSources_ImportFactFournFromCogilog_View {

	protected $potype = 'receipt';
	protected $potypePrefix = 'BR';
}