...
class RSNQueriesVariables extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_rsnqueriesvariables';
	var $table_index= 'rsnqueriesvariablesid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_rsnqueriesvariablescf', 'rsnqueriesvariablesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_rsnqueriesvariables', 'vtiger_rsnqueriesvariablescf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_rsnqueriesvariables' => 'rsnqueriesvariablesid',
		'vtiger_rsnqueriesvariablescf'=>'rsnqueriesvariablesid');

	/**
	 * Mandatory for Listing (Related listview)
	 */
	var $list_fields = Array (
		'LBL_NAME' => array('rsnqueriesvariables', 'name'),
		'LBL_LABEL' => array('rsnqueriesvariables', 'variablelabel'),
		'LBL_REFERENCEFIELD' => array('rsnqueriesvariables', 'referencefield'),
		'LBL_TYPE' => array('rsnqueriesvariables', 'type'),
		'LBL_DEFAULTVALUE' => array('rsnqueriesvariables', 'defaultvalue'),
		'LBL_DISABLED' => array('rsnqueriesvariables', 'disabled'),
		'LBL_SEQUENCE' => array('rsnqueriesvariables', 'sequence'),

	);
	var $list_fields_name = Array (
		'LBL_NAME' => 'name',
		'LBL_LABEL' => 'variablelabel',
		'LBL_REFERENCEFIELD' => 'referencefield',
		'LBL_TYPE' => 'type',
