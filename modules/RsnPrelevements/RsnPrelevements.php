...
class RsnPrelevements extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_rsnprelevements';
	var $table_index= 'rsnprelevementsid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_rsnprelevementscf', 'rsnprelevementsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_rsnprelevements', 'vtiger_rsnprelevementscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_rsnprelevementscf'=>'rsnprelevementsid');

	/**
	 * Mandatory for Listing (Related listview)
	 */
	var $list_fields = Array (
		'LBL_ACCOUNTID' => array('rsnprelevements', 'accountid'),
		'LBL_PRELVTYPE' => array('rsnprelevements', 'prelvtype'),
		'LBL_ETAT' => array('rsnprelevements', 'etat'),
		'LBL_PERIODICITE' => array('rsnprelevements', 'periodicite'),
		'LBL_MONTANT' => array('rsnprelevements', 'montant'),
		'LBL_ORIGINE' => array('rsnprelevements', 'origine'),

	);
	var $list_fields_name = Array (
		'LBL_ACCOUNTID' => 'accountid',
		'LBL_PRELVTYPE' => 'prelvtype',
		'LBL_ETAT' => 'etat',
		'LBL_PERIODICITE' => 'periodicite',
		'LBL_MONTANT' => 'montant',
		'LBL_ORIGINE' => 'origine',
