...
class RSNSQLQueries_DetailView_Model extends Vtiger_DetailView_Model {
	...
	public function getWidgets() {
		...
		//TMP execution -> usefull to test query speed ?
		$widgets[] = array(
				'linktype' 	=> 'DETAILVIEWWIDGET',
				'linklabel'	=> 'Exécution',
				'linkName'	=> 'execution',
				'linkField'	=> 'rsnsqlqueriesid', //tmp to check !!
		...
		$relatedInstance = Vtiger_Module_Model::getInstance('RSNQueriesVariables');
		$widgets[] = array(
				'linktype' => 'DETAILVIEWWIDGET',
				...
				'linkurl' => 'module='.$this->getModuleName().'&view=Detail&record='.$this->getRecord()->getId().
						'&relatedModule=RSNQueriesVariables&mode=showRelatedRecords&page=1&limit=25',
				'action'	=>	array('Refresh'),
				'actionlabel'	=>	array(''),
				'actionURL' =>	''
		);
