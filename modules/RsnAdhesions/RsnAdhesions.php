...
class RsnAdhesions extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_rsnadhesions';
	var $table_index= 'rsnadhesionsid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_rsnadhesionscf', 'rsnadhesionsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_rsnadhesions', 'vtiger_rsnadhesionscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_rsnadhesions' => 'rsnadhesionsid',
		'vtiger_rsnadhesionscf'=>'rsnadhesionsid');
