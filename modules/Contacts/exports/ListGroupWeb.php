...
class Contacts_ListGroupWeb_Export extends Contacts_ListGroupStats_Export {
	...
	function getExportStructure() {
		return array(
			...
			"latitude" => function($row) {return Products_ProductsAll_Export::formatFloatVal($row["latitude"]); },
			"longitude" => function($row) {return Products_ProductsAll_Export::formatFloatVal($row["longitude"]); },
		);
	}
