...
class Contacts_ListGroupMailingAG_Export extends Contacts_ListGroupStats_Export {
	...
	function getExportStructure() {
		return array(
			...
			"Fax" => "fax",
			"Portable" => "mobile",
			"e-mail" => function($row) { return Contacts_ListGroupMailingAG_Export::getEmailInfos($row); },
			"Région" => "mailingregion",
			"Département" => "mailingdepartment",//tmp dep number ??
			"Dernière Adhésion" => "max_adh",
			"InfoAdhésion" => function($row) { return Contacts_ListGroupMailingAG_Export::getInfoAdhesion($row); },
			"Site Web" => "websiteurl",
			"Type Groupe" => "grptypes",
			"Nb adhérents" => function($row) { return Contacts_ListGroupMailingAG_Export::getNbAdhenrents($row); },
			"Descriptif" => function($row) { return Contacts_ListGroupMailingAG_Export::getTruncatedDescription($row); },
		);
	}
