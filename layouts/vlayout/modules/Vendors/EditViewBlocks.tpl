	...
	<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
		...
		{foreach key=BLOCK_LABEL item=BLOCK_FIELDS from=$RECORD_STRUCTURE name="EditViewBlockLevelLoop"}
			...
			{foreach key=FIELD_NAME item=FIELD_MODEL from=$BLOCK_FIELDS name=blockfields}
				...
				{if $FIELD_NAME eq 'street2'
				|| $FIELD_NAME eq 'street3'
				|| $FIELD_NAME eq 'addressformat'
				|| $FIELD_NAME eq 'postalcode'
				|| $FIELD_NAME eq 'pobox'
				|| $FIELD_NAME eq 'country'}
					{continue}
				{/if}
						...
						<div class="row-fluid">
							<span class="span10">
								...
								{if $FIELD_NAME eq 'city'}
									...
									{assign var=FIELD_NAMETMP value=$FIELD_NAME}
									{assign var=FIELD_MODELTMP value=$FIELD_MODEL}
									{assign var=FIELD_NAME value=str_replace('city', 'postalcode', $FIELD_NAME)}
									{assign var=FIELD_MODEL value=$BLOCK_FIELDS[$FIELD_NAME]}
									{assign var=UITYPEMODEL value=$FIELD_MODEL->getUITypeModel()->getTemplateName()}
