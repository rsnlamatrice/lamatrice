...
{strip}
	<span class="span10 margin0px">
		<span class="row-fluid">
			...
			{if $RECORD->get('etat') neq '0'}
				<span class="recordLabel font-x-x-large textOverflowEllipsis span pushDown" style="color: red">
					{if $RECORD->get('etat') == 1}Prélèvement suspendu
					{elseif $RECORD->get('etat') == 2}Prélèvement arrété
					{/if}
				</span>
			{/if}
		</span>
