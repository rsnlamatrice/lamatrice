	...
	<table style="width:80%;margin-left:auto;margin-right:auto;margin-top:10px;" cellpadding="10" class="searchUIBasic well">
		<tr>
			<td class="font-x-large" align="left" colspan="2">
				<span class="redColor">{sizeof($NEW_CURRENCIES)} {if sizeof($NEW_CURRENCIES) gt 1}{'LBL_NEW_CURRENCY_FOUND_DURING_IMPORT_PLURAL'|@vtranslate:$MODULE}{else}{'LBL_NEW_CURRENCY_FOUND_DURING_IMPORT'|@vtranslate:$MODULE}{/if}:
					<br/>
		...
		<tr>
			<td valign="top">
				<table cellpadding="10" cellspacing="0" align="center" class="dvtSelectedCell thickBorder importContents">
					<tr>
						<td class="redColor">{'LBL_CURRENCY'|@vtranslate:$MODULE}</td>
					</tr>
					{foreach item=_CURRENCY from=$NEW_CURRENCIES}
						<tr>
							<td>{$__CURRENCY}</td>
						</tr>
					{/foreach}
		...
		<tr>
			<td align="right" colspan="2">
				<button name="currencies_settings" class="btn btn-primary"
					onclick="return window.open('index.php?parent=Settings&module=Currency&view=List','Devises','width=1200,height=800,resizable=no,scrollbars=yes,top=150,left=200');"><strong>{'LBL_CURRENCIES'|@vtranslate:$MODULE}</strong></button>
				&nbsp;&nbsp;
