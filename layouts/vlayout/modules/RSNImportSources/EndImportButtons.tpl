	...
	<tr>
		<td align="right" colspan="2">
			...
			<button name="next" class="create btn"
			   onclick="location.href='index.php?module={$FOR_MODULE}&view=Import&return_module={$FOR_MODULE}&return_action=index&defaultsource={$IMPORT_SOURCE}'" ><strong>{'LBL_IMPORT_MORE'|@vtranslate:$MODULE}</strong></button>
			&nbsp;&nbsp;
