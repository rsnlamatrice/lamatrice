...
<div class="row-fluid span">
	<form class="form-horizontal" id="CustomView" name="CustomView" method="post" action="index.php">
		...
		<div class="filterActions">
			...
			<button class="btn btn-success save-copy pull-right marginRight10px hide" id="customViewSubmitCopy" type="submit"><strong>{vtranslate('LBL_SAVE_COPY', $MODULE)}</strong></button>
		</div>
	</form>
</div>
{/strip}
