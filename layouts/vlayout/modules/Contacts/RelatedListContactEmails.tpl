...
<div class="relatedContents contents-bottomscroll">
	...
	{assign var=WIDTHTYPE value=$USER_MODEL->get('rowheight')}
		...
		{assign var=IS_MAIN_ADDRESS value=$RELATED_RECORD->get('emailaddressorigin') eq 'LBL_CURRENT_ADDRESS'}
		
		{assign var=VIEW_URL value=$RELATED_RECORD->getDetailViewUrl()}
		{if $IS_MAIN_ADDRESS}{assign var=VIEW_URL value=str_replace('ContactEmails', 'Contacts', $VIEW_URL)}{/if}
