<table cellpadding="5" cellspacing="0" align="center" width="100%" class="dvtSelectedCell thickBorder importContents">
	...
	<tr>
		...
		{if $IMPORT_RESULT['SKIPPED'] neq '0'}
			&nbsp;&nbsp;<a class="cursorPointer" 
				onclick="return window.open('index.php?module={$MODULE}&view=Detail&mode=getImportDetails&type=skipped&start=1&foruser={$OWNER_ID}&for_module={$FOR_MODULE}','skipped','width=700,height=650,resizable=no,scrollbars=yes,top=150,left=200');">
	...
	<tr>
		...
		{if $IMPORT_RESULT['FAILED'] neq '0'}
			&nbsp;&nbsp;<a class="cursorPointer" onclick="return window.open('index.php?module={$MODULE}&view=Detail&mode=getImportDetails&type=failed&start=1&foruser={$OWNER_ID}&for_module={$FOR_MODULE}','failed','width=700,height=650,resizable=no,scrollbars=yes,top=150,left=200');">{'LBL_DETAILS'|@vtranslate:$MODULE}</a><!-- TMP Link -->
		{/if}
		</td>
	</tr>
</table>