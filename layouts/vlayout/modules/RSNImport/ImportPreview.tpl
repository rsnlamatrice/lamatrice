			...
			{foreach from=$PREVIEW_DATA key=MODULE_NAME item=MODULE_DATA}
				<tr>
					<td class="font-x-large" align="left" colspan="2">
						<span class="big">{'LBL_IMPORT_PREVIEW_FOR_MODULE'|@vtranslate:$MODULE} {$MODULE_NAME|@vtranslate:$MODULE_NAME}:</span>
					</td>
				</tr>
				<tr>
					<td valign="top">
			...
			<tr>
				...
				<td align="right" colspan="2">
					<form onsubmit="" action="index.php" enctype="multipart/form-data" method="POST" name="selectImportSource">
						...
						{include file='PreviewButtons.tpl'|@vtemplate_path:'RSNImport'}<!-- TMP -->
					</form>
				</td>
			</tr>
		</table>
