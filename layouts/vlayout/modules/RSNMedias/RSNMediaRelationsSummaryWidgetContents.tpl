				...
				<li>
					<div class="row-fluid">
						...
						<div class="span3 textOverflowEllipsis">
							<a href="{$RELATED_RECORD->getDetailViewUrl()}" id="{$MODULE}_{$RELATED_MODULE}_Related_Record_{$RELATED_RECORD->get('id')}" title="{$RELATED_RECORD->getDisplayValue('vtiger_rsnmediacontacts_nom')}">
								{$RELATED_RECORD->getDisplayValue('mediacontactid')}
							</a>
						</div>
